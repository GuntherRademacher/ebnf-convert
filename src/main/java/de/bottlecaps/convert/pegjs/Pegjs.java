...
// REx command line: -tree -a none -java -interface de.bottlecaps.convert.Parser -basex -saxon -name de.bottlecaps.convert.pegjs.Pegjs pegjs.ebnf

package de.bottlecaps.convert.pegjs;
...
public class Pegjs implements de.bottlecaps.convert.Parser
{
  ...
  public static abstract class SaxonDefinition extends ExtensionFunctionDefinition
  {
    ...
    @Override
    public StructuredQName getFunctionQName() {return new StructuredQName("p", "de/bottlecaps/convert/pegjs/Pegjs", functionName());}
    @Override
  ...
  public static ANode parseGrammar(Str str) throws IOException
  {
    ...
    {
      @Override
      public void execute(Pegjs p) {p.parse_Grammar();}
    };
  ...
  {
    protected abstract void execute(Pegjs p);
