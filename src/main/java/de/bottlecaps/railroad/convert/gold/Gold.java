...
// REx command line: -backtrack -tree -a none -java -interface de.bottlecaps.railroad.convert.Parser -saxon10 -name de.bottlecaps.railroad.convert.gold.Gold gold.ebnf
...
public class Gold implements de.bottlecaps.railroad.convert.Parser
{
  ...
  public static abstract class SaxonDefinition extends ExtensionFunctionDefinition
  {
    ...
    @Override
    public StructuredQName getFunctionQName() {return new StructuredQName("p", "Gold", functionName());}
    @Override
