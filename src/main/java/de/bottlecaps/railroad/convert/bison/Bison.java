// This file was generated on Tue Jul 13, 2021 20:53 (UTC+02) by REx v5.53 which is Copyright (c) 1979-2021 by Gunther Rademacher <grd@gmx.net>
// REx command line: -tree -a none -java -interface de.bottlecaps.railroad.convert.Parser -saxon10 -name de.bottlecaps.railroad.convert.bison.Bison bison.ebnf
...
public class Bison implements de.bottlecaps.railroad.convert.Parser
{
  ...
  public static abstract class SaxonDefinition extends ExtensionFunctionDefinition
  {
    ...
    @Override
    public StructuredQName getFunctionQName() {return new StructuredQName("p", "Bison", functionName());}
    @Override
