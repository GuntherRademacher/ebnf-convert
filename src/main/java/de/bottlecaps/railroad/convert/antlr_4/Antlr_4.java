...
// REx command line: -backtrack -tree -a none -java -interface de.bottlecaps.railroad.convert.Parser -saxon10 -name de.bottlecaps.railroad.convert.antlr_4.Antlr_4 antlr_4.ebnf
...
public class Antlr_4 implements de.bottlecaps.railroad.convert.Parser
{
  ...
  public static abstract class SaxonDefinition extends ExtensionFunctionDefinition
  {
    ...
    @Override
    public StructuredQName getFunctionQName() {return new StructuredQName("p", "Antlr_4", functionName());}
    @Override
